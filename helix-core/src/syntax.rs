    ...
    pub fn update(
        ...
        while let Some(layer_id) = queue.pop_front() {
            PARSER.with(|ts_parser| {
                ...
                // Process injections.
                // let mut cursor = ts_parser.cursors.pop().unwrap_or_else(QueryCursor::new); // TODO: return on stack
                ...
                // TODO: for some reason only last injection in the doc is highlighted
        ...
        log::info!("len {} {:?}", self.layers.len(), self.layers);
